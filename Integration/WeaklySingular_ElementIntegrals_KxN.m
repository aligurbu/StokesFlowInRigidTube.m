...
if found_mex_WeaklySingularIntegrals_KxN
    ...
    switch xnodenum
        case 1
            ...
            thet_max = pi/4; 
            rmax_fn = 1;
            KxN_tr1 = WeaklySingularIntegrals_KxN_M(xi_e, chi, ...
                                                    zetachi1, zetachi2, ...
                                                    thet_min, thet_max, ...
                                                    rmax_fn,...
                                                    grx, grw, gtx, gtw);
            ...
            thet_max = pi/2; 
            rmax_fn = 2;
            KxN_tr2 = WeaklySingularIntegrals_KxN_M(xi_e, chi, ...
                                                    zetachi1, zetachi2, ...
                                                    thet_min, thet_max, ...
                                                    rmax_fn,...
                                                    grx, grw, gtx, gtw);
        ...
        case 5
            ...
            thet_max = pi; 
            rmax_fn = 11;
            KxN_tr3 = WeaklySingularIntegrals_KxN_M(xi_e, chi, ...
                                                    zetachi1, zetachi2, ...
                                                    thet_min, thet_max, ...
                                                    rmax_fn,...
                                                    grx, grw, gtx, gtw);
        ...
        case 9
            ...
            thet_max = 7*pi/4;
            rmax_fn = 24;
            KxN_tr4 = WeaklySingularIntegrals_KxN_M(xi_e, chi, ...
                                                    zetachi1, zetachi2, ...
                                                    thet_min, thet_max, ...
                                                    rmax_fn,...
                                                    grx, grw, gtx, gtw);
