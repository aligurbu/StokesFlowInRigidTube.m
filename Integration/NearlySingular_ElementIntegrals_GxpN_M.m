function GxpN = NearlySingular_ElementIntegrals_GxpN_M(xi_e, chi, mu, ...
                                                       grx, grw, gtx, gtw, ...
                                                       zetap1, zetap2)
%%
...
if (zetap1 == -1 && zetap2 == -1) % Node 1
    ...
    thet_max = pi/4;
    rmax_fn = 1;
    GxpN_tr1 = NearlySingularIntegrals_GxpN_M(xi_e, chi, mu, ...
                                              zetap1, zetap2, ...
                                              thet_min, thet_max, ...
                                              rmax_fn,...
                                              grx, grw, gtx, gtw);
    ...
    thet_max = pi/2;
    rmax_fn = 2;
    GxpN_tr2 = NearlySingularIntegrals_GxpN_M(xi_e, chi, mu, ...
                                              zetap1, zetap2, ...
                                              thet_min, thet_max, ...
                                              rmax_fn,...
                                              grx, grw, gtx, gtw);
...
elseif (zetap2 == -1)  % Generalized Node 5
    ...
    thet_max = pi;
    rmax_fn = 11;
    GxpN_tr3 = NearlySingularIntegrals_GxpN_M(xi_e, chi, mu, ...
                                              zetap1, zetap2, ...
                                              thet_min, thet_max, ...
                                              rmax_fn,...
                                              grx, grw, gtx, gtw);
...
elseif (zetap1 == -1)  % Generalized Node 8
    ...
    rmax_fn = 24;
    GxpN_tr4 = NearlySingularIntegrals_GxpN_M(xi_e, chi, mu, ...
                                              zetap1, zetap2, ...
                                              thet_min, thet_max, ...
                                              rmax_fn,...
                                              grx, grw, gtx, gtw);
