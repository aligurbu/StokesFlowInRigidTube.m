function Plot_TractionPressureShearFieldsOnVessel...
            (coord, connect, wallnodeOnlyWallLine, ...
             ...
             name, verbose_PrintProfiles, PlotVectorFieldsIsTrue)
...
if strcmp(name,'ShortMicrocapillary_16El')
    ConstantShearOnVesselSideWall = ...
                             NormShearNodalArranged(wallnodeOnlyWallLine)';
    AnalyticalConstantShearOnVesselSideWall = ...
              InletPressure*(pi*TubeRadius^2)/(2*pi*TubeRadius*TubeLength);
	fprintf('Analytical -- Shear on the side wall is %4.4f Pa\n', ...
                                   AnalyticalConstantShearOnVesselSideWall)
end
fig = gcf;
fig.NumberTitle = 'off';
