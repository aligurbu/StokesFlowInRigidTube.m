...
! call: [GN, K] = RegularIntegrals_GN_K(chi,xie,nhat,wJ,BasisFn,mu)
...
mwPointer chi, xie, nhat, wJ, BasisFn, GN, K
mwPointer NG2
...
call RegularIntegrals_GN_K(%val(chi), %val(xie), %val(nhat), %val(wJ), & 
...
subroutine RegularIntegrals_GN_K(chi, xie, nhat, wJ, BasisFn, & 
                                 mu, NG2, GN, K)
...
end subroutine RegularIntegrals_GN_K
